...
$titulo=$rw['titulo'];
$descripcion_corta=$rw['descripcion_corta'];
		 ...
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Portafolio</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="descripcion_corta" value="<?php echo $descripcion_corta;?>" required name="descripcion_corta">
				</div>
			  </div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="url" class="form-control" id="url_web" value="<?php echo $url_web;?>"  name="url_web">
				</div>
			  </div>
