...
$insert=mysqli_query($con,"insert into portafolio (url_image, estado) values ('$imagen_demo','2')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from portafolio order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from portafolio where id='$id_banner' limit 0,1");
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar portafolio</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="descripcion_corta" value="" required name="descripcion_corta">
				</div>
			  </div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="url" class="form-control" id="url_web" value=""  name="url_web">
				</div>
			  </div>
